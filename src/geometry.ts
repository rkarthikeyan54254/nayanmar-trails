...
export const GEO_SEEDS: GeoSeed[] = [
  ...
  { siteId: 'KT039', name: 'Mayiladuthurai', nameTa: 'மயிலாடுதுறை', lng: 79.6550, lat: 11.1035, playbackRank: 6, geometryStatus: 'modern_place_centroid_product_metadata' },
  { siteId: 'KT026', name: 'Kumbakonam', nameTa: 'கும்பகோணம்', lng: 79.3881, lat: 10.9602, playbackRank: 7, geometryStatus: 'modern_place_centroid_product_metadata' },
  { siteId: 'KV51', name: 'Tiruvaiyaru', nameTa: 'திருவையாறு', lng: 79.1044, lat: 10.8845, playbackRank: 8, geometryStatus: 'modern_place_centroid_product_metadata' },
  { siteId: 'KV60', name: 'Tiruvanaikaval', nameTa: 'திருவானைக்காவல்', lng: 78.7058, lat: 10.8530, playbackRank: 9, geometryStatus: 'modern_place_centroid_product_metadata' },
  { siteId: 'KT006', name: 'Tiruchirappalli', nameTa: 'திருச்சிராப்பள்ளி', lng: 78.7047, lat: 10.7905, playbackRank: 10, geometryStatus: 'modern_place_centroid_product_metadata' },
  { siteId: 'KT087', name: 'Tiruvarur', nameTa: 'திருவாரூர்', lng: 79.6368, lat: 10.7726, playbackRank: 11, geometryStatus: 'modern_place_centroid_product_metadata' },
  { siteId: 'KT125', name: 'Vedaranyam', nameTa: 'வேதாரண்யம்', lng: 79.8502, lat: 10.3720, playbackRank: 12, geometryStatus: 'modern_place_centroid_product_metadata' },
  { siteId: 'PA01', name: 'Madurai', nameTa: 'மதுரை', lng: 78.1198, lat: 9.9252, playbackRank: 13, geometryStatus: 'modern_place_centroid_product_metadata' },
  { siteId: 'PA08', name: 'Rameswaram', nameTa: 'இராமேச்சுரம்', lng: 79.3129, lat: 9.2876, playbackRank: 14, geometryStatus: 'modern_place_centroid_product_metadata' },
];
